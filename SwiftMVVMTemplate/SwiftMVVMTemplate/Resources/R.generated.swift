...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct launchScreen: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      let bundle = R.hostingBundle
      let initialSplitViewController = StoryboardViewControllerResource<UIKit.UIViewController>(identifier: "InitialSplitViewController")
      let name = "LaunchScreen"

      func initialSplitViewController(_: Void = ()) -> UIKit.UIViewController? {
      ...
      static func validate() throws {
        ...
        if _R.storyboard.launchScreen().initialSplitViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'initialSplitViewController' could not be loaded from storyboard 'LaunchScreen' as 'UIKit.UIViewController'.") }
      }
